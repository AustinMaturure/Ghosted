...
const LoadingSkeleton = () => {
    return (
        <main className="container animate-pulse mx-auto flex flex-col lg:flex-row gap-10 lg:gap-12 sm:px-1 py-12 lg:py-0">
                ...
                <div className="flex flex-col-reverse sm:px-0 max-w-[40rem] lg:flex-col gap-2 xl:flex-row lg:gap-6">
                    ...
                    <div className="sm:px-0 w-[30rem] lg:w-[35rem]">
                        <div className="w-full h-auto bg-gray-200 rounded-xl">
                            <svg
                                className="w-full h-auto text-gray-200 block object-contain"
                                aria-hidden="true"
            ...
            <div className="lg:border-l-[0.75px] lg:border-r-[0.75px] sm:border-gray-400  flex flex-col gap-6 lg:gap-8">
                ...
                <div className="lg:w-[30rem] grid gap-8 lg:gap-10">
                    <div className="w-full px-3 grid gap-2">
                        ...
                        <div>
                            <div>Colors:</div>
                            <div className="h-10 bg-gray-200 rounded-md  max-w-[480px] mb-2.5"></div>
                        </div>
                        <div className="">
                            <div>Size:</div>
